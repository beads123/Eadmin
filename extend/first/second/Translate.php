...
class Translate 
{
	...
	// public $APP_ID="20170415000044920"; //替换为您的APPID
	// public $SEC_KEY="pMx5L_RnHPlrqT_9buuC";//替换为您的密钥

	//翻译入口
	public function go($query, $from, $to)
	{
		$args = array(
			'q' => $query,
			'appid' => "20170415000044920",
			'salt' => rand(10000,99999),
			'from' => $from,
			'to' => $to,

		);
		$args['sign'] = $this->buildSign($query, "20170415000044920", $args['salt'], "pMx5L_RnHPlrqT_9buuC");
